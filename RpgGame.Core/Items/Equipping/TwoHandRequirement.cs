...
namespace RpgGame.Core.Items.Equipping
{
    ...
    {
        public void Equip(Player player, Weapon weapon, HandSlot preferredSlot) // For 2-handed weapons, we ignore the preferredSlot and just unequip both hands and equip the weapon in both.
        {
        ...
        public void Unequip(Player player, Weapon weapon)   // Just unequip the weapon from both hands, back to inventory.
        {
