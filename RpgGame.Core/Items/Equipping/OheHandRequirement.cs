...
namespace RpgGame.Core.Items.Equipping
{
    ...
    {
        public void Equip(Player player, Weapon weapon, HandSlot preferredSlot) // The preferredSlot is just a hint; if it's occupied, we can try the other hand.
        {
        ...
        public void Unequip(Player player, Weapon weapon)   // Just unequip the weapon from whichever hand it's in, back to inventory.
        {
